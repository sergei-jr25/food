(() => {
        ...
        e.exports = function (e, t, r, o, h, g, O) {
          ...
          if (
            ...
            if (((L = { values: M(S), keys: g ? N : M(E), entries: M(T) }), O))
              for (A in L) (x || z || !(A in _)) && f(_, A, L[A]);
  ...
  (r.n = (e) => {
    ...
    (() => {
      ...
      var me,
        ...
        ze = function (e, t) {
          ...
          var r = getComputedStyle(e),
            ...
            w = n ? v + m : 0,
            E = n ? g + b : 0,
            S = i ? i.width : Ae(r.width) - w - x,
            T = i ? i.height : Ae(r.height) - E - y,
            C = S + v + x + m,
            O = T + g + y + b,
            k = be({
              devicePixelContentBoxSize: Me(
      ...
      const lt = document.querySelectorAll("[data-scroll]");
      function ct() {
        lt.forEach((e, t) => {
